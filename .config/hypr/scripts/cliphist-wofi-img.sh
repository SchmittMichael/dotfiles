...
# sourced from https://github.com/sentriz/cliphist/blob/master/contrib/cliphist-wofi-img
...
# choice=$(gawk <<< $cliphist_list "$prog" | wofi -I --dmenu --column 2 -Dimage_size=100 -Dynamic_lines=true)
choice=$(gawk <<< $cliphist_list "$prog" | wofi -I --dmenu --display-columns 2 -Dimage_size=100 -Dynamic_lines=true)
